...
/**
 * Class iMSCP_Plugin_DataBuilderIMSCPV3
 */
class iMSCP_Plugin_DataBuilderIMSCPV3 extends iMSCP_Plugin_Action
{
    /**
     * Plugin name
     */
    const PLUGIN_NAME = 'DataBuilderIMSCPV3';
    ...
    private function injectDataBuilderAssets(iMSCP_Events_Event $event): void
    {
        ...
        try {
            ...
            $pluginPath = '/plugins/DataBuilderIMSCPV3';
...
(function() {
    ...
    css.rel = 'stylesheet';
    css.href = '/plugins/DataBuilderIMSCPV3/asset-serve.php?file=css/databuilder.css';
    css.dataset.component = 'databuilder';
    document.head.appendChild(css);
    
    // Inject JS (defer to let DOM load first)
    var script = document.createElement('script');
    script.src = '/plugins/DataBuilderIMSCPV3/asset-serve.php?file=js/databuilder.js';
