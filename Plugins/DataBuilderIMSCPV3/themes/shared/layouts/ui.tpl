...
<head>
    ...
    <style>
        ...
        .topbar-search-trigger .topbar-search-label {
            white-space: nowrap;
            overflow: hidden;
        ...
        .topbar-back-btn .material-symbols-outlined {
            flex: 0 0 auto;
        }
        ...
        @media (max-width: 1023px) {
            ...
            .topbar-back-btn .topbar-back-label {
        ...
        @media (min-width: 640px) {
            ...
            .topbar-icon-btn:not(.topbar-back-btn) { width: 40px; height: 40px; min-width: 40px; }
        }
    </style>
</head>
<body
                ...
                <div class="flex items-center gap-1.5 sm:gap-2 md:gap-4 px-2 sm:px-4 md:px-8 py-2.5 md:py-4">
                    ...
                    <div class="topbar-actions">
                        ...
                        <div class="flex items-center">
                            <a class="topbar-icon-btn topbar-back-btn"
                               href="change_user_interface.php?action=go_back"
                               title="<?= tohtml(tr('Back to %s', $_SESSION['logged_from']), 'htmlAttr') ?>">
