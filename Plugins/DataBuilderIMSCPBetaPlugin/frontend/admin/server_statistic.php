<?php
// iMSCP Server Statistics page rendered with DataBuilder Magento-lite
// This file is the standard iMSCP endpoint that can be called from the admin panel menu
// It uses DataBuilder to render the page instead of the TPL template system
...
try {
    ...
    error_log('SERVER_STATISTIC ERROR: ' . $e->getMessage() . ' in ' . $e->getFile() . ':' . $e->getLine());
